                    ...
                    <div align="center">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr align="left" valign="top">
                          <th height="50%" align="center" valign="middle" class="Estilo61" scope="col">
                            <p align="justify" class="Estilo47">FITNEES</p>
                            <p align="justify" class="Estilo47">Nuestro Club cuenta con un completo GIMNASIO propio
                              dotado con toda clase de maquinaria y elementos deportivos:</p>
                            <div align="justify">
                              <ul>
                                <li class="Estilo47">Fitnees</li>
                                <li class="Estilo47">Aerobico</li>
                                <li class="Estilo47">Musculaci&oacute;n</li>
                                <li class="Estilo47">Sauna&hellip;</li>
                              </ul>
                            </div>
                            <p align="justify" class="Estilo47">Contamos con monitor deportivo propio y pista de Squash
                            </p>
                            <p align="center">&nbsp;</p>
                            <p align="center"><img src="images/fitnees.jpg" alt="FITNEES" width="850" height="478" longdesc="FITNEES" /></p>
                            <div align="center"></div>
                          </th>
                        </tr>
                        <tr align="left" valign="top">
                          <th height="50%" align="center" valign="middle" class="Estilo61" scope="col">&nbsp;</th>
                        </tr>
                      </table>
                    </div>
                  </td>
