                        ...
                        <tr align="left" valign="top">
                          <th height="50%" align="center" valign="top" class="Estilo61" scope="col">
                            <div align="center">
                              ...
                              <p class="Cabecera_titulo">PISCINA</p>
                              <table width="100%" border="0">
                                <tr>
                                  <th scope="col">&nbsp;</th>
                                  <th scope="col">
                                    <p align="justify" class="Estilo47">La PISCINA de nuestro Club es una de las zonas
                                      con m&aacute;s actividad, l&oacute;gicamente en la temporada de verano. En ella
                                      tenemos varias zonas: vaso de ba&ntilde;o de 12 x 9 mts, playa, duchas, vestuario,
                                      sol&aacute;rium y terraza de verano con barbacoa y acceso al bar restaurante<br />
                                      Un lugar ideal para pasar el caluroso verano ecijano.</p>
                                  </th>
                                  <th scope="col">&nbsp;</th>
                                </tr>
                                <tr>
                                  <th width="10%" scope="col">&nbsp;</th>
                                  <th scope="col"><img src="images/piscina.jpg" width="850" height="478" /></th>
                                  <th width="10%" scope="col">&nbsp;</th>
                                </tr>
                              </table>
