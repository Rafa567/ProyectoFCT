              ...
              <table border="0" cellpadding="0" cellspacing="0" width="80%%">
                ...
                <tr>
                  ...
                  <td colspan="13" rowspan="2" align="center" valign="top">
                    <p class="Cabecera_titulo">SAUNA</p>
                    <table width="100%" border="0">
                      <tr>
                        <th scope="col">&nbsp;</th>
                        <th scope="col">
                          <p align="justify" class="Estilo47">Nuestro Club cuenta con un SAUNA y MESA DE MASAJES para
                            posibilitar un ba&ntilde;o a vapor a la medida de cada socio.<br />
                            La Sauna dispone de varias potencias y un generador de vapor con unidad digital para el
                            control de caldera y v&aacute;lvula manual de descarga.</p>
                        </th>
                        <th scope="col">&nbsp;</th>
                      </tr>
                      <tr>
                        <th width="10%" scope="col">&nbsp;</th>
                        <th scope="col"><img src="images/sauna.jpg" width="850" height="638" /></th>
                        <th width="10%" scope="col">&nbsp;</th>
                      </tr>
                    </table>
