                  ...
                  <td colspan="13" rowspan="2" align="center" valign="top">
                    <div align="center">
                      ...
                      <div align="center">
                        <p>&nbsp;</p>
                        <div align="center">
                          <p class="Cabecera_titulo">BIENVENIDA</p>
                          <table width="80%" border="0">
                            <tr>
                              <th width="10%" scope="col">&nbsp;</th>
                              <th scope="col"><img src="images/bienvenidacollage.jpg" alt="bienvenidacollage" width="835" height="150" longdesc="bienvenidacollage" /></th>
                              <th width="10%" scope="col">&nbsp;</th>
                            </tr>
                          </table>
                        </div>
                        <div align="center">
                          <p align="justify"><span class="Estilo50"><em>Bienvenido al espacio web de la Sociedad
                                <strong>Tenis Club de &Eacute;cija</strong>. </em></span></p>
                          <p align="justify"><span class="Estilo50"><em>Esta p&aacute;gina web donde usted se encuentra
                                ahora mismo es una ventana virtual que pretende mostrar la idiosincrasia de nuestro club
                                ofreciendo a trav&eacute;s de ella una&nbsp; breve exposici&oacute;n de lo que este club
                                ha sido a lo largo de los a&ntilde;os, lo que es en la actualidad, lo que ofrece a sus
                                socios y amigos, incluso lo que puede darle a usted.</em><br />
                              <em>Sum&eacute;rjase en nuestra web y encuentre, tal vez, lo que llevaba tanto tiempo
                                buscando y no hab&iacute;a encontrado&hellip;.</em><br />
                              <em>Bienvenido a la Sociedad <strong>Tenis Club de &Eacute;cija</strong>. Bienvenido a su
                                Club.</em></span></p>
                        </div>
