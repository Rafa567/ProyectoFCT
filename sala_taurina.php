              ...
              <table border="0" cellpadding="0" cellspacing="0" width="80%%">
                ...
                <tr>
                  ...
                  <td colspan="13" rowspan="2" align="center" valign="top">
                    ...
                    <p class="Cabecera_titulo">SALA TAURINA</p>
                    <table width="100%" border="0">
                      <tr>
                        <th scope="col">&nbsp;</th>
                        <th scope="col">
                          <div align="justify">
                            <p class="Estilo47">La Sala Taurina se ha creado con la idea de mantener encendida la llama
                              de los aficionados de nuestro club, y de nuestra ciudad en general, a la fiesta del toro.
                              Su principal objetivo es&nbsp; cultivar y honrar el amor a esta expresi&oacute;n cultural
                              tan arraigada en nuestro pa&iacute;s y en nuestra ciudad en particular y convertirla en
                              punto de encuentro de aficionados con solera, artistas y gente del toro.<br />
                              La sala est&aacute; decorada con motivos taurinos donados por aficionados y gente del toro
                              de nuestra ciudad. Sus fondos est&aacute;n compuestos por pinturas, carteles taurinos,
                              bronces, azulejos, &nbsp;trajes de luces, capotes de de brega y paseo, cabezas de toros,
                              etc.<br />
                              Su entrada se ubica en una puerta anexa al patio principal del Club. En su interior se
                              podr&aacute; tambi&eacute;n disponer de la carta del restaurante de nuestro club para
                              degustar sus tapas y bebidas antes de comer y despu&eacute;s de las corridas que pueden
                              verse a trav&eacute;s de la televisi&oacute;n.</p>
                            <p class="Estilo47">Esta estancia tambi&eacute;n se ha planteado como oferta
                              cultural-taurina, con una serie de actividades que Peri&oacute;dicamente incluye
                              exposiciones de pintura, escultura y fotograf&iacute;a de los artistas&nbsp;m&aacute;s
                              conocidos de nuestra ciudad, poblaciones cercanas y de nivel nacional, as&iacute; como
                              charlas y coloquios, documentales, etc., relacionadas con el mundo del toro.</p>
                          </div>
                        </th>
                        <th scope="col">&nbsp;</th>
                      </tr>
                      <tr>
                        ...
                        <th scope="col"><img src="images/taurina.jpg" alt="Salon Taurino" width="775" height="500" longdesc="Salon Taurino" /></th>
                        <th width="10%" scope="col">&nbsp;</th>
                      </tr>
                    </table>
                    <p class="Cabecera_titulo">&nbsp;</p>
...
<script src="js/salataurina.js"></script>
