              ...
              <table border="0" cellpadding="0" cellspacing="0" width="80%%">
                ...
                <tr>
                  ...
                  <td colspan="13" rowspan="2" align="center" valign="top">
                    ...
                    <p class="Cabecera_titulo">SALA INFANTIL JUVENIL</p>
                    <table width="100%" border="0">
                      <tr>
                        <th scope="col">&nbsp;</th>
                        <th scope="col"><span class="Estilo47">
                            <div align="justify" class="Estilo47">
                          </span>
                          <p align="justify" class="Estilo47">Nuestro Club cuenta con una SALA INFANTIL donde los
                            m&aacute;s peque&ntilde;os pueden jugar y entretenerse mientras sus padres est&aacute;n en
                            el Club.<br />
                            Cuenta con:</p>
                          <span class="Estilo47">
                            <ul>
                          ...
                          <div align="justify">
                            <ul>
                              <li class="Estilo47">Mesa de ping-pong</li>
                              <li class="Estilo47">Futbol&iacute;n</li>
                              <li class="Estilo47">Tv-Play Station</li>
                              <li class="Estilo47">Etc.&hellip;</li>
                              <li class="Estilo47">Servicio de cuidadora en Semana Santa, Feria y Navidades.</li>
                              <li></li>
                            </ul>
                          </div>
                        </th>
                      ...
                      <tr>
                        ...
                        <th scope="col"><img src="images/sala_infantil.jpg" alt="SALA INFANTIL" width="850" height="478" longdesc="Sala infantil" /></th>
                        <th width="10%" scope="col">&nbsp;</th>
                      </tr>
                    </table>
                  </td>
...
<script src="js/salainfantil.js"></script>
