          ...
          <div align="center">
            <div id="FWTableContainer1752007515">
                        ...
                        <tr align="left" valign="top">
                          <th height="50%" align="center" valign="top" class="Estilo61" scope="col">
                            ...
                            <table width="80%" height="100" border="0" align="center">
                              <tr>
                                <th class="Estilo50" scope="col"><a href="galerias/galeria.php"><img src="images/historia1.jpg" alt="historia1" width="200" height="96" border="0" longdesc="historia1" /></a></th>
                                <th class="Estilo50" scope="col"><a href="galerias/galeria.php"><img src="images/historia2.jpg" alt="historia2" width="200" height="96" border="0" longdesc="historia1" /></a></th>
                                <th class="Estilo50" scope="col"><a href="galerias/galeria.php"><img src="images/historia3.jpg" alt="historia3" width="200" height="96" border="0" longdesc="historia1" /></a></th>
                              </tr>
                            </table>
              ...
              <div id="MMMenuContainer0312205212_2">
                <div id="MMMenu0312205212_2" onmouseout="MM_menuStartTimeout(1000);" onmouseover="MM_menuResetTimeout();"> <a href="reserva_socios.php" target="_top" id="MMMenu0312205212_2_Item_0" class="MMMIFVStyleMMMenu0312205212_2" onmouseover="MM_menuOverMenuItem('MMMenu0312205212_2');"> Reserva&nbsp;socios </a> <a href="reserva_no_socios.php" target="_top" id="MMMenu0312205212_2_Item_1" class="MMMIVStyleMMMenu0312205212_2" onmouseover="MM_menuOverMenuItem('MMMenu0312205212_2');">
                    Reserva&nbsp;NO&nbsp;socios </a> </div>
              </div>
              <div id="MMMenuContainer0312205212_3">
                <div id="MMMenu0312205212_3" onmouseout="MM_menuStartTimeout(1000);" onmouseover="MM_menuResetTimeout();"> <a href="ingreso.php" target="_top" id="MMMenu0312205212_3_Item_0" class="MMMIFVStyleMMMenu0312205212_3" onmouseover="MM_menuOverMenuItem('MMMenu0312205212_3');"> Ingreso </a> <a href="baja.php" target="_top" id="MMMenu0312205212_3_Item_1" class="MMMIVStyleMMMenu0312205212_3" onmouseover="MM_menuOverMenuItem('MMMenu0312205212_3');"> Baja </a> </div>
              </div>
            </div>
          </div>
        </td>
