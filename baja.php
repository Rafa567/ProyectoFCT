                ...
                <tr>
                  ...
                  <td colspan="13" rowspan="2" align="center" valign="top">
                    <div align="center">
                      <div align="center">
                        <p>&nbsp;</p>
                        <p class="Cabecera_titulo"><strong>Solicitud de BAJA DE SOCIO</strong></p>
                        <p class="Cabecera_titulo"><strong> por formulario o bajando el PDF</strong></p>
                        <p class="Cabecera_titulo">&nbsp;</p>
                        <p class="Cabecera_titulo">&nbsp;</p>



                        <form action="gracias1.php" method="post" name="Contacto" id="Contacto">

                          <p class="Estilo47">&nbsp;</p>
                          <table width="90%">
                            <tr>
                              <td width="93%" valign="middle" class="Estilo47" scope="row">
                                <div align="center">RELLENE ESTE FORMULARIO PARA LA SOLICITUD DE BAJA DE SOCIO.</div>
                              </td>
                              <td width="7%" class="Estilo47"><a href="BAJA_SOCIO.pdf" target="_blank"><img src="images/pdf_download.png" alt="Bajar PDF" width="45" height="45" border="0" longdesc="Bajar PDF" /></a></td>
                            </tr>
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                                <div align="center">En la ciudad de
                                  <input name="ciudad" type="text" id="ciudad" size="20" required />
                                  del dia
                                  <input name="dia" type="text" id="dia" size="1" required />
                                  mes
                                  <input name="mes" type="text" id="mes" size="8" required />
                                  a&ntilde;o
                                  <input name="ano" type="text" id="ano" size="2" required />
                                </div>
                              </th>
                            </tr>
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                                <div align="center"><strong><em>Sr. Presidente de la Sociedad Deportiva Tenis Club de
                                      Ecija</em></strong></div>
                              </th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                                <div align="center"><strong>S O L I C I T O &nbsp;LA&nbsp; BAJA COMO SOCIO/A </strong>de
                                  la Sociedad Deportiva Tenis Club de Ecija<strong></strong></div>
                              </th>
                            </tr>
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                                <div align="center">(Se&ntilde;ale lo que proceda)</div>
                              </th>
                            </tr>
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                                <div align="center">
                                  <input type="radio" name="eleccion" value="OK" id="definitiva" required />
                                  Definitiva
                                  <input type="radio" name="eleccion" value="OK" id="temporal" />
                                  Temporal, durante un per&iacute;odo de
                                  <input name="fechatemporal" type="text" id="fechatemporal" size="10" />
                                  <input type="radio" name="eleccion2" value="OK" id="propia" />
                                  Propias
                                  <input type="radio" name="eleccion2" value="OK" id="misfamilia" />
                                  de mis Familiares : </div>
                              </th>
                            </tr>
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                            ...
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                                <div align="center">Nombre
                                  <input name="Nombrefam3" type="text" id="Nombrefam3" size="20" required />
                                  DNI
                                  <input name="dnifam3" type="text" id="dnifam3" size="8" required />
                                  Nombre
                                  <input name="Nombrefam4" type="text" id="Nombrefam4" size="20" required />
                                  DNI
                                  <input name="dnifam4" type="text" id="dnifam4" size="8" required />
                                </div>
                              </th>
                            </tr>
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                                <div align="center">Rogando se haga efectivo a partir del dia
                                  <input name="diaefec" type="text" id="diaefec" size="2" required />
                                  del mes
                                  <input name="mesefec" type="text" id="mesefec" size="10" required />
                                  a&ntilde;o
                                  <input name="anoefec" type="text" id="anoefec" size="4" required />
                                </div>
                              </th>
                            </tr>
                            <tr>
                              <th height="30" colspan="2" valign="top" class="Estilo47" scope="row">
                                <div align="center">motivos y circunstancias siguientes:
                                  <textarea name="motivos" cols="80" id="motivos"></textarea>
                                </div>
                              </th>
                            </tr>
                            ...
                            <tr>
                              <th height="30" colspan="2" valign="middle" class="Estilo47" scope="row">
                                <div align="center">Esperando que sea atendida mi solicitud, reciba un cordial saludo
                                </div>
                              </th>
                            </tr>
                            <tr>
                          ...
                          <p class="Estilo47">
                            <label for="radiobutton">
                              <input name="aviso_legal" type="checkbox" id="aviso_legal" checked="checked" required />
                              He leido el aviso legal<br />
                              <br />
                            </label>
                            <input name="submit2" id="btnEnviar" type="submit" value="     Envielo     " />
                            <input name="reset2" type="reset" id="reset" value="Borrar todo" />
                          </p>
                        </form>


                        <p class="Cabecera_titulo">(<a href="aviso_legal.php" target="_blank">Aviso Legal</a>) </p>
                      </div>
