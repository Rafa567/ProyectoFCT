...
CookieTool.Config = (function() {
	var config = {
		'position': 'fixed',
		'message': 'En este sitio se usan cookies para ofrecer una experiencia más personalizada. <a href="{{link}}" target="_top">Más información</a>.<br>¿Nos consiente usar cookies?',
		'link': '/cookies',
		'agreetext': 'Sí',
		'declinetext': 'No'
	}
